...
import { getResourceBookmarks, getStoredUser, navItems, normalizeStudyResource, resourceCategories, saveResourceBookmarks, trimesterOptions } from '../utils/appData'
      ...
      <main className="dashboard-canvas resources-page-canvas">
        ...
        <header className="resources-page-header">
          ...
          <div className="resources-header-tools">
            ...
            <button type="button" className="primary-soft-button" onClick={() => navigate('/upload-resources')}>Upload file</button>
          </div>
        </header>

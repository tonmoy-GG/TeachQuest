...
public interface UserRepository extends JpaRepository<User, Long> {
    ...
    Optional<User> findByUsername(String username);
        ...
        java.util.List<Object[]> countByUserType();
            ...
            java.util.List<Object[]> registrationCountsByWeek(@Param("since") LocalDateTime since);
        ...
        Page<User> searchAdminUsers(@Param("role") String role, @Param("status") String status,
